...
###----Resume-Training----###
RESUME_TRAINING=0
RESUME_TRAIING_MODEL='/image_data/Scripts/NLP_Classification_CNN/Liver_Classification/Multi_Label/Model_Multi_Label/'
...
TRAINING_SAVE_MODEL_PATH='/image_data/Scripts/NLP_Classification_CNN/Liver_Classification/Multi_Label/Model_Multi_Label/'
TRAINING_CSV='Liver_Multi_Label.csv'
LOG_NAME="Log_Liver_Multi_Label"
MODEL_SAVING_NAME="nlp_Liver_Multi_Label{val_loss:.2f}_{epoch}.h5"
