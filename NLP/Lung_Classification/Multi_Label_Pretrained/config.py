...
###----Resume-Training----###
RESUME_TRAINING=0
RESUME_TRAIING_MODEL='/image_data/Scripts/NLP_Classification_CNN/Lung_Classification/Multi_Label_Pretrained/Model_Multi_Label_Pretrained/'
...
TRAINING_SAVE_MODEL_PATH='/image_data/Scripts/NLP_Classification_CNN/Lung_Classification/Multi_Label_Pretrained/Model_Multi_Label_Pretrained/'
TRAINING_CSV='Lung_Multi_Label_Pretrained.csv'
LOG_NAME="Log_Lung_Multi_Label_Pretrained"
MODEL_SAVING_NAME="nlp_Lung_Multi_Label_Pretrained{val_loss:.2f}_{epoch}.h5"
